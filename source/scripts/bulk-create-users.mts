  ...
  return new Promise((resolve, reject) => {
    ...
    rows.forEach((row, idx) => {
      ...
      doc
        ...
        .font(bodyBoldFont)
        .fontSize(labelSize)
        .text('USERNAME', x + pad, cy);
      cy += gapLabelToValue;
      doc
        .fillColor(ink)
        .font(monoBoldFont)
        .fontSize(valueSize)
        .text(row.username, x + pad, cy);
      cy += gapSection;
      ...
      doc
        ...
        .font(bodyBoldFont)
        .fontSize(labelSize)
        .text('PASSWORD', x + pad, cy);
      cy += gapLabelToValue;
      doc
        .fillColor(ink)
        .font(monoBoldFont)
        .fontSize(valueSize)
        .text(row.password, x + pad, cy);
      cy += gapSection;
      ...
      doc
        ...
        .font(bodyBoldFont)
        .fontSize(labelSize)
        .text('CONSOLE', x + pad, cy);
      cy += gapLabelToValue;
      doc
        .fillColor(mid)
        .font(bodyFont)
        .fontSize(urlSize)
        .text(consoleUrl, x + pad, cy, { link: consoleUrl });
      cy += gapSection;
      ...
      doc
        ...
        .font(bodyFont)
        .fontSize(urlSize)
        .text(eventUrl, x + pad, cy, { link: eventUrl });
    });
